...
export const cityContentTier2: Record<string, PageContent> = {
  "sell-my-house-fast-leavenworth-ks": {
    ...
    body: [
      ...
      "[KS] Property in this city is assessed the same way it is assessed anywhere else in the state: Article 11, Section 1 of the Kansas Constitution fixes the residential ratio at 11.5% of market value, a figure this county's own assessor applies to whatever value estimate a specific parcel carries, with nothing about a military-adjacent local economy changing the constitutional percentage itself.",

      "[KS] A house in this city financed with a mortgage no longer carries the old Kansas mortgage-registration tax on its closing statement -- K.S.A. 79-3102 was repealed outright effective January 1, 2019, and the repeal reaches a closing in this city exactly as it reaches one anywhere else in Kansas.",
  ...
  "sell-my-house-fast-leawood-ks": {
    ...
    body: [
      ...
      "[KS] Because this city sits in Johnson County, Kansas, a house in this city answers to Kansas law start to finish -- no Missouri trustee, no Missouri notice period, and no Missouri redemption right reaches a property in this city, regardless of how the word \"Johnson\" alone might be misread against a county on the far side of the state.",

      "[KS] The rule that matters most for a homeowner in this specific city is Kansas's own uncapped homestead shield. Kan. Const. Art. 15 Section 9 and K.S.A. 60-2301 keep an eligible homestead safe from a forced sale under any process of law with no dollar limit on its value written into the exemption -- and because home values in this city run well above almost anywhere else in this footprint, that missing ceiling protects far more real equity in this city than the identical rule protects in a more modestly priced Kansas city.",

      "[KS] That protection compounds with this Kansas county's own tax-sale holding period. K.S.A. 79-2401a requires Johnson County, Kansas to sit on a property it bids off at a tax foreclosure sale for two years before pursuing a further sale, stretching to three years specifically when the property qualifies as a homestead -- and given how much of this city's housing stock is large, owner-occupied, and long-held, that three-year figure reaches an unusually large share of the parcels in it.",
      ...
      "[KS] The 11.5% residential assessment ratio Article 11, Section 1 of the Kansas Constitution sets is identical in this city to what it is everywhere else in the state -- what differs, and differs sharply in this particular city, is the market-value estimate underneath that ratio, which runs well above the footprint's average given how this city's own housing stock is priced.",

      "[KS] Large-lot zoning has shaped this city since it incorporated in the 1950s, and much of that zoning survives largely unchanged today -- a fact about local land-use planning, not about the statewide statutes above, but one reason a comparable house in this city tends to sit on more land than one in a denser, older Kansas suburb closer to the urban core.",

      "[KS] None of the above means a cash sale is never the right call in this city -- a thin-equity owner once a large mortgage and any liens are counted, an estate needing an uncomplicated and fast close, or a property carrying repair needs no conventional lender will finance can all make a cash sale the sensible answer in this city too. The point is that this city's own combination of high equity and unusually protective Kansas rules deserves a genuine look at what is actually at stake before a quick sale becomes the assumed default.",

      "[KS] None of this is legal advice, and whether a specific property in this city genuinely qualifies as a homestead under the constitutional definition is a fact question for a Kansas attorney or the Johnson County, Kansas, treasurer's office, not something a general city overview can settle on its own.",
    ],
    claims: [
      citations["ks-homestead"],
      citations["ks-tax-sale-county-holding-period"],
  ...
  "sell-my-house-fast-liberty-mo": {
    ...
    body: [
      ...
      "[MO] A missed mortgage payment on a house in this city sets off the same non-judicial process as anywhere in the state: RSMo 443.290 gives a named trustee the power of sale, RSMo 443.327 lets that trustee actually carry out the sale once default occurs, and no lawsuit or judge is required at any point in that sequence.",
      ...
      "The Jesse James Bank Museum, housed in the original 1858 bank building the James-Younger gang is generally credited with robbing in broad daylight in 1866, still sits on this city's own historic square -- a well-documented piece of local history with no bearing on which statutes reach a house sale in this city.",
  ...
  "sell-my-house-fast-gladstone-mo": {
    ...
    body: [
      ...
      "[MO] The statewide money figures reach a house in this city exactly as they reach one anywhere else in Missouri: RSMo 513.475 shields $15,000 of equity from an unsecured creditor's judgment today, a figure rising to $40,000 on January 1, 2027 under a law already signed, and RSMo 137.115 taxes an ordinary residential parcel at 19% of its market value regardless of a city's own size.",
      ...
      "[MO] A homeowner in this city selling a house that once contained a permitted or unpermitted solid waste disposal site or demolition landfill has to disclose that fact in writing early in the negotiation, along with a warning that the buyer may be assuming liability for remedial action -- RSMo 260.213. That is a description of a statewide duty that would attach if either condition applied to a specific parcel, not a claim that it does in this city.",

      "[MO] None of the above turns a fast cash sale into the default choice for a seller in this city. Time before a trustee's-sale notice is even published is usually better spent bringing the loan current or testing a normal listing first, since this city's steady, mostly postwar housing stock tends to hold real appeal for a conventional buyer once it actually goes on the market.",
  ...
  "sell-my-house-fast-belton-mo": {
    ...
    body: [
      ...
      "[MO] A rapidly growing subdivision base means more parcels in this city are being assessed for the first time as new construction than as a reassessment of an older home, but the identical 19% ratio under RSMo 137.115 applies to a brand-new house exactly as it applies to an older one closer to the county seat.",
  ...
  "sell-my-house-fast-gardner-ks": {
    ...
    body: [
      ...
      "[KS] Every part of this city sits in Johnson County, Kansas -- not the differently named Johnson County, Missouri, roughly 65 miles southeast, that this site's Warrensburg page covers -- so a house in this city answers to Kansas law throughout, with no Missouri statute reaching it regardless of that shared county name.",

      "[KS] New subdivision construction has driven most of this city's growth over the past two decades, and a newer subdivision in this city more often carries a special assessment or improvement-district fee tied to that construction than an older Johnson County, Kansas home closer to the built-up core does. K.S.A. 12-6a20 requires a Kansas seller to disclose any such special assessment or fee to a buyer -- making a good-faith estimate if the exact figure is not yet fixed -- and to get the buyer's written acknowledgment of that disclosure before closing.",
      ...
      "[KS] A closing on a house in this city also skips the old Kansas mortgage-registration tax -- K.S.A. 79-3102 was repealed outright effective January 1, 2019, and that repeal reaches a newer subdivision closing in this city exactly as it reaches one anywhere else in the state.",

      "[KS] Property in this city is assessed at the same fixed 11.5% ratio Article 11, Section 1 of the Kansas Constitution sets statewide, applied to whatever market-value estimate the county assessor sets for a specific parcel -- new construction and an older home nearby carry the identical percentage, only the underlying value estimate differs.",
  ...
  "sell-my-house-fast-raymore-mo": {
    ...
    body: [
      ...
      "[MO] Because so much of this city's own housing stock is recent construction, a larger share of parcels in this city are being assessed for the first time as new build than as a reassessment of an existing home -- but the identical 19% figure under RSMo 137.115 applies to a house finished last year exactly as it applies to an older, long-settled home over in Harrisonville or Pleasant Hill.",
  ...
  "sell-my-house-fast-emporia-ks": {
    ...
    body: [
      "Emporia sits roughly 99.4 miles from the metro's core, the farthest city this entire site covers, in Lyon County -- a genuinely different market from anywhere closer to the Kansas City line, built around Emporia State University and long associated with William Allen White, the newspaper editor whose Emporia Gazette made this small city nationally known in the early 1900s. Roughly 24,105 people live in this city.",

      "[KS] Lyon County has no dedicated hub page on this site yet, given how far outside the closer-in metro counties it sits, so a seller in this city looking for the county-level detail behind the figures below should treat the statewide Kansas pages as the more complete reference rather than a Lyon County page that does not exist.",

      "[KS] Distance does not change which law governs, though -- every acre of this city sits in Kansas, so a house in this city answers to the identical statewide statutes reaching Johnson County or Wyandotte County, nearly a hundred miles closer to the state line, with nothing about this city's own remoteness altering which rule applies.",

      "[KS] A mortgage default on a house in this city runs through Kansas's judicial process the same way it does anywhere in the state -- K.S.A. 60-2410 requires the lender to win a lawsuit first, K.S.A. 60-2415 requires the district court sitting in this city to confirm the resulting sheriff's sale, and only then does K.S.A. 60-2414 open a redemption window, twelve months as the default or three when an early default hit a heavily leveraged loan.",

      "[KS] The uncapped homestead exemption reaches a house in this city exactly as it reaches one in the closer-in metro core -- Kan. Const. Art. 15 Section 9 and K.S.A. 60-2301 shield an eligible homestead from forced sale with no dollar limit written into the exemption, regardless of how much lower this city's own home values run compared with Johnson County's.",

      "[KS] A delinquent-tax sale in this city follows the same before-the-sale-only structure Kansas uses statewide -- K.S.A. 79-2803 shuts off redemption once the sale itself happens, while K.S.A. 79-2401a still requires Lyon County to sit on a bid-off property for two years before a further sale, three when the property qualifies as a homestead.",

      "This city's own resale market moves on a rhythm the closer-in metro core does not share -- turnover in this city often clusters around Emporia State's own academic calendar, a genuinely rural-college-town pattern rather than the faster, more continuous churn of Johnson County's suburban market, even though the identical Kansas statutes above reach both.",

      "[KS] Property in this city is assessed at the same fixed 11.5% ratio Article 11, Section 1 of the Kansas Constitution sets statewide, applied to a market-value estimate that runs well below what the same ratio produces on a comparable home closer to the metro core -- the percentage itself never moves; only the underlying value estimate does.",

      "[KS] A house financed in this city also carries none of the old Kansas mortgage-registration tax -- K.S.A. 79-3102 was repealed effective January 1, 2019, a repeal that reaches a closing in this city exactly as it reaches one anywhere else in the state, however far this city sits from the metro core.",

      "[KS] Settling an estate that owns a house in this city still means clearing the same K.S.A. 59-3202 test every Kansas estate faces -- a court, not the will alone, decides whether the estate proceeds as simplified or supervised, weighing its size, the heirs' agreement, and its solvency.",
  ...
  "sell-my-house-fast-prairie-village-ks": {
    ...
    body: [
      "Prairie Village is one of the earliest large-scale planned suburban developments in the entire Kansas City metro, laid out beginning in the 1940s with curving streets and a shopping village built into the plan from the start -- a design that still shapes this city today. Its own population runs roughly 22,900, in Johnson County, Kansas, about 8.4 miles from the metro's core -- closer in than almost any other city in this footprint.",

      "[KS] This city sits in Johnson County, Kansas, not the differently named Johnson County, Missouri, roughly 65 miles southeast, described on this site's Warrensburg page -- a house in this city answers to Kansas law throughout, with no Missouri statute reaching it regardless of the county name the two share.",

      "[KS] Because this city was built out decades ago, most of its housing stock is now considerably older than the newer subdivisions found in Gardner or Spring Hill farther out in the same county -- a difference in age that shapes which houses in this city actually draw a conventional lender's real interest, but not which state's statutes reach a sale.",
      ...
      "[KS] That exemption pairs with a second Kansas rule specific to this county: K.S.A. 79-2401a makes Johnson County, Kansas hold a bid-off property for two full years before any further sale, stretching to three when the parcel qualifies as a homestead -- so a homeowner in this city facing delinquent taxes generally has years, not weeks, before the county moves toward that further sale.",
      ...
      "[KS] Because so much of this city's own housing stock is decades old, a licensee handling a sale in this city often has more accumulated knowledge of a specific property's quirks than a licensee selling new construction elsewhere in the county would -- and K.S.A. 58-30,106 makes that knowledge legally relevant, requiring the seller's agent to disclose adverse material facts actually known to a buyer who counts only as a customer.",

      "[KS] A closing on a house in this city also skips the old Kansas mortgage-registration tax -- K.S.A. 79-3102 was repealed effective January 1, 2019, the same repeal reaching a closing anywhere else in Johnson County, Kansas.",

      "[KS] Property in this city is assessed at the identical fixed 11.5% ratio Article 11, Section 1 of the Kansas Constitution sets statewide -- what varies, and varies meaningfully given how established and sought-after this city's own location is, is the underlying market-value estimate the county assessor sets for a given parcel.",

      "J.C. Nichols, the developer behind the Country Club Plaza in Kansas City, Missouri, laid out much of this city's original street plan in the postwar years -- a planning legacy that survives in its curving streets and central shopping village today, a fact about local design history rather than about which state's law actually reaches a house sale in this city.",
  ...
  "sell-my-house-fast-sedalia-mo": {
    ...
    body: [
      "Sedalia is the seat of Pettis County, roughly 22,086 people about 77 miles southeast of the metro's core -- well past the closer-in Missouri counties this site covers, and home to the Missouri State Fair every August since 1901, an event that draws far more visitors to this city for a couple of weeks a year than its own population would suggest. Composer Scott Joplin lived in this city in the 1890s, and wrote the Maple Leaf Rag in this city before it became one of the best-known ragtime compositions ever published.",
      ...
      "[MO] No state or local transfer tax reaches a closing in this city, either -- the same constitutional bar under Article X, Section 25 of the Missouri Constitution that reaches every Missouri city in this footprint, adopted by voters in 2010.",

      "The Missouri State Fair draws well over a hundred thousand visitors to this city across its own run every August, filling short-term lodging and putting real, if temporary, pressure on the local housing and rental market for a couple of weeks each summer -- a real seasonal fact about this city's own economy, unrelated to which statutes actually reach a house sale in this city the rest of the year.",

      "[MO] None of the above makes a fast cash sale the obvious answer for a seller in this city. An owner with time before a trustee's-sale notice is even published -- and that notice runs faster in this city than in a larger county, so there is genuinely less runway once it starts -- usually still comes out ahead bringing the loan current or listing conventionally if there is time left to do it.",

      "[MO] None of this is legal advice, and the county's own genuinely faster weekly-notice schedule makes getting prompt advice more valuable in this city than in a much bigger county. A Sedalia owner with a real notice, tax bill, or probate filing already in hand should get it in front of a licensed Missouri attorney quickly, not treat this general overview as any kind of final word.",
    ],
    claims: [
      citations["mo-nonjudicial"],
      citations["mo-notice-period"],
  ...
  "sell-my-house-fast-warrensburg-mo": {
    ...
    body: [
      ...
      "[MO] Every part of this city sits in Missouri, so a house in this city answers to Missouri's trustee-driven foreclosure process, Missouri's own homestead and assessment figures, and Missouri probate -- never the judicial foreclosure process, the uncapped homestead exemption, or the Kansas probate test that reach a Johnson County, Kansas city with an almost identical name roughly 65 miles to the northwest.",
      ...
      "This county has no dedicated hub page on this site yet, so a seller in this city looking for the county-level detail behind these figures should treat the statewide Missouri page as the fuller reference -- and should double check, on a tax statement or deed, that the words \"Johnson County\" printed there carry Missouri alongside them, not Kansas, given how easily the two get confused.",
      ...
      "[MO] A hard PCS deadline tied to Whiteman Air Force Base is a genuine reason to weigh a fast cash sale in this city -- a conventional buyer's financing timeline rarely beats a report date measured in weeks, and a base transfer can arrive with less notice than a typical civilian relocation would. A homeowner in this city without that deadline, and without a pressing default, is usually still better off bringing a loan current or listing conventionally, and should not assume Kansas's own more protective homestead rule reaches a house on this side of the state line, because it does not.",

      "[MO] None of this is legal advice, and confirming which Johnson County a given piece of information actually describes matters more in this city than almost anywhere else in this footprint. A Warrensburg homeowner should verify the state printed on an actual tax statement or deed before assuming any rule applies, and a Missouri attorney, not a general summary, is who should field a specific foreclosure, tax, or estate question from there.",
    ],
    claims: [
      citations["mo-nonjudicial"],
      citations["mo-notice-period"],
  ...
  "sell-my-house-fast-grain-valley-mo": {
    ...
    body: [
      ...
      "[MO] Missing a mortgage payment on a house in this small city triggers the identical trustee mechanism the rest of Jackson County uses -- RSMo 443.290 hands the named trustee power of sale, RSMo 443.327 lets that trustee actually carry it out, and because the county's own population sits well above the 50,000-person mark RSMo 443.320 sets, notice still has to run for twenty insertions in a daily newspaper even for a city this size.",

      "[MO] This city also sits inside the same Jackson County reassessment dispute affecting every other city sharing this county -- the Missouri State Tax Commission's August 6, 2024 order found the 2023 cycle skipped required notice and inspection on parcels facing sharp increases, and the Missouri Court of Appeals revived the Commission's own enforcement suit on December 30, 2025 without deciding it on the merits. A homeowner in this city whose own valuation jumped sharply has an active process to raise with the county assessor, not a settled result -- the fuller account lives on this site's dedicated Jackson County reassessment page.",
      ...
      "[MO] Whether a redemption right ever follows a trustee's sale in this city comes down to RSMo 443.410 and RSMo 443.420's own three-part test -- the lender, not a third-party investor, has to be the buyer at the sale; the borrower has to give written notice of an intent to redeem; and a bond covering the debt has to be posted inside twenty days of the sale.",
      ...
      "[MO] A closing in this small city carries no transfer tax whatsoever -- Article X, Section 25 of the Missouri Constitution has barred the state, Jackson County, and every city inside it, this one included, from creating one since 2010.",

      "This city has grown steadily as commuters priced out of Blue Springs or Lee's Summit look one exit farther out along I-70, a pattern that has kept new subdivision construction going in this city even while the historic core along its own original main street stays small and largely unchanged.",
