...
export const countyContentMetro: Record<string, PageContent> = {
  ...
  "sell-my-house-fast-johnson-county-ks": {
    ...
    body: [
      "Johnson County, Kansas is the second-largest county in this site's entire 53-county footprint and by a wide margin the wealthiest, spanning sixteen cities in two distinct tiers -- Overland Park, Olathe, Lenexa, Leawood, Gardner, Spring Hill, De Soto, and Edgerton farther out toward the county's own edges, and Shawnee, Merriam, Mission, Prairie Village, Roeland Park, Fairway, Mission Hills, and Westwood in a smaller, closer-in cluster nearer the Wyandotte County line -- across roughly 622,237 people, about 20 miles from the Kansas City core. Home values and household incomes across this county run well above most of the rest of this site's footprint, and that difference changes the honest answer to whether a fast cash sale even makes sense for a lot of homeowners in this county specifically.",
      ...
      "[KS] The sixteen cities in this county are not one uniform market. Overland Park and Olathe carry substantial resale activity on their own; Leawood ranks among the highest-value residential areas in this entire footprint; Gardner, Spring Hill, De Soto, and Edgerton, while bound by the identical tax and exemption rules, sit farther from the built-up core and trade at slower paces and lower price points; and a second, considerably smaller group -- Shawnee, Merriam, Mission, Prairie Village, Roeland Park, Fairway, Mission Hills, and Westwood -- packs tightly built, largely postwar housing stock into this county's own corner nearest the Wyandotte County border, a different market again from either of the other two clusters.",
  ...
  "sell-my-house-fast-clay-county-mo": {
    ...
    body: [
      ...
      "[MO] Past that notice schedule, the sale itself runs on the same statewide mechanics as any other Missouri county. RSMo 443.290 and RSMo 443.327 give the named trustee authority to sell on default with no lawsuit required, and a narrow redemption window can follow under RSMo 443.410 and RSMo 443.420 -- but only if the lender itself is the buyer at the sale, the borrower gives notice of an intent to redeem, and a bond covering the debt goes up within twenty days of the sale. The Missouri trustee-sale-timeline page on this site covers that four-part sequence in depth; this page only flags that it applies.",
  ...
  "sell-my-house-fast-wyandotte-county-ks": {
    ...
    body: [
      "Wyandotte County is home to Kansas City, Kansas -- a separate city, in a separate state, from Kansas City, Missouri, despite sharing almost the same name and sitting less than 10 miles from the Missouri city's own downtown. Roughly 165,281 people live across this county's four cities: Kansas City itself, Bonner Springs, Edwardsville, and Lake Quivira. Several smaller, closely built communities often assumed to share this county -- Shawnee, Merriam, Mission, Prairie Village, Roeland Park, Fairway, Mission Hills, and Westwood -- actually sit just across this county's own eastern line, in Johnson County instead.",

      "[KS] That name overlap causes real confusion for a homeowner trying to work out which state's law applies to a specific address, and the answer is unambiguous: every one of the four cities above sits in Wyandotte County, Kansas, not Missouri, so Kansas law -- not Missouri law -- governs a foreclosure, a redemption period, a homestead exemption, or a property tax assessment on a house in this county, regardless of how many times \"Kansas City\" appears on a piece of mail addressed to it. A seller who assumes Missouri's trustee-sale process or its one-year redemption right governs a sale in this county, because the city is named Kansas City, is working from the wrong state's rules entirely.",
      ...
      "[KS] The four cities in this county differ sharply from one another. Kansas City itself carries the large majority of this county's population and its industrial and urban core; Bonner Springs and Edwardsville sit farther out along the Kansas River, each with a small-town center of its own rather than an extension of the urban core; and Lake Quivira, a private gated community built around its own lake, is unlike any other place on this county's list. The closely built suburbs a homeowner might expect to find rounding out this county's roster -- Mission, Mission Hills, Westwood, Fairway, Roeland Park, Merriam, Prairie Village, and Shawnee -- in fact sit across this county's eastern line in Johnson County, this site's own Johnson County page covering the rules reaching them.",
  ...
  "sell-my-house-fast-platte-county-mo": {
    ...
    body: [
      ...
      "[MO] This county's own five cities lean smaller and more distinct from each other than a countywide summary suggests. Parkville, sitting along the Missouri River, carries an active small-downtown resale market built around its riverfront and a private university campus; Platte City is the county seat and a modest, steady residential market; Riverside sits closer to Kansas City's own core than any other city in this county, its small residential footprint increasingly shaped by riverfront casino and commercial development rather than a conventional suburban center; Weston is a small historic river town with an older, tighter housing stock; and Weatherby Lake is a small, lake-centered residential community organized around private lake access rather than a conventional street grid.",
      ...
      "[MO] The math changes once a trustee's-sale notice has actually been published; short of that, a fast cash sale is rarely the right call for a seller in this county. An owner with time before a notice of trustee's sale is published usually comes out ahead bringing the loan current, negotiating with the lender, or listing through a realtor -- and that is especially true in Parkville and Weston, where an older or architecturally distinctive home can draw real buyer interest a fast, as-is cash sale would not capture.",
  ...
  "sell-my-house-fast-cass-county-mo": {
    ...
    body: [
      ...
      "[MO] An owner in Belton or Raymore with time before a trustee's-sale notice runs, and real equity worth protecting, is not the seller a fast cash sale is built for. An owner with time before a trustee's-sale notice is published usually comes out ahead bringing the loan current or listing through a realtor, particularly in Belton or Raymore where buyer demand for newer construction remains strong; an owner working through a Cass County estate has real reason to confirm who actually holds authority to sign before assuming a sale, quick or otherwise, can move forward at all.",
