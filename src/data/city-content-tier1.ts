...
export const cityContentTier1: Record<string, PageContent> = {
  ...
  "sell-my-house-fast-overland-park-ks": {
    ...
    body: [
      ...
      "[KS] That does not mean a cash offer is automatically the wrong choice for every seller in this city, either. A thin-equity owner once the mortgage and liens are counted, an estate that needs a fast and uncomplicated close, or a property carrying repair needs no conventional lender will touch can all make a cash sale the sensible answer, wealthy city or not -- the real point is that this city's combination of high equity and unusually protective Kansas rules earns a genuine look at what is actually at stake before a quick sale becomes the assumed default.",
  ...
  "sell-my-house-fast-kansas-city-ks": {
    ...
    body: [
      ...
      "[KS] No dollar cap limits the homestead shield reaching a house in this city, either -- Kan. Const. Art. 15 Section 9 together with K.S.A. 60-2301 keeps an eligible homestead safe from forced sale no matter its value, and the flat 11.5% assessment ratio Article 11, Section 1 of the Kansas Constitution sets applies to this city the same way it applies in Johnson County or the Shawnee County containing Topeka -- only the assessor's own market-value estimate ever actually changes.",
      ...
      "[KS] A house sitting in a place called Kansas City is no reason by itself to accept a fast cash offer. An owner with real equity and no pressing deadline does better confirming the county on a tax statement or plat map first, remembering that this city's twelve-month redemption window and uncapped homestead protection are Kansas's own, and weighing an ordinary listed sale before taking a discounted offer.",

      "[KS] None of this is legal advice, and given how often this city's own name gets confused with the Missouri city sharing it, that caution matters more for a Kansas City, Kansas address than most places in this footprint -- a homeowner should verify the actual parcel number or tax statement, not the mailing address, before assuming which state governs, and should bring anything time-sensitive to a Kansas attorney rather than guessing.",
    ],
    claims: [
      citations["ks-judicial"],
      citations["ks-redemption-12mo"],
  ...
  "sell-my-house-fast-topeka-ks": {
    ...
    body: [
      ...
      "[KS] Financing a purchase of a house in this city no longer triggers the old Kansas mortgage-registration tax either -- K.S.A. 79-3102, the statute that once imposed it, was repealed outright effective January 1, 2019, and nothing has revived it since.",

      "[KS] Settling an estate that owns a house in this city still means passing the K.S.A. 59-3202 test every Kansas estate faces -- a judge, not the will, decides whether simplified or supervised administration applies, based on the estate's size, how well the heirs get along, its solvency, and what administering it is likely to cost.",
  ...
  "sell-my-house-fast-lawrence-ks": {
    ...
    body: [
      ...
      "[KS] A rental in this city that's in poor shape, saddled with tenants who won't easily leave, or tied to a lease running against the closing date a seller wants is often a strong candidate for a cash sale -- both a conventional lender and a normal listing calendar tend to struggle with an occupied rental far more than a vacant, owner-occupied house. A well-maintained, owner-occupied home in this city with no deadline pressure sits on the opposite end -- listing it through a realtor is very often the better outcome.",

      "[KS] None of this is legal advice, and this is one of the few topics on this site where a specialist matters more than a generalist -- whether a specific property in this city actually qualifies as a homestead, and how a specific lease or tenancy affects how fast it can sell, calls for a Kansas attorney who handles both real estate and landlord-tenant law, not a general summary of countywide rules.",
    ],
    claims: [
      citations["ks-judicial"],
      citations["ks-redemption-12mo"],
  ...
  "sell-my-house-fast-lenexa-ks": {
    ...
    body: [
      ...
      "[KS] None of this is legal advice. A Kansas attorney or the Johnson County treasurer's office, not this summary, is where to confirm whether a given property in this city actually qualifies as a homestead and how the county's multi-year holding period reaches a specific parcel.",
    ],
    claims: [
      citations["ks-homestead"],
      citations["ks-tax-sale-county-holding-period"],
